...
public class MainAppDay11 implements ApplicationRunningInterface{

	public static void main(String[] args) {
		MainAppDay11 mainAppDay11 = new MainAppDay11();
		mainAppDay11.run();
	}

	@Override
	public void run() {
		ApplicationContext context = new ClassPathXmlApplicationContext("beans_day11_byType.xml");
		System.out.println("-------- day 11: Scope Bean ------");

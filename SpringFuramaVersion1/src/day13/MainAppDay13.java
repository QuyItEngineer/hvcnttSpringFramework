...
public class MainAppDay13 implements ApplicationRunningInterface{

	public static void main(String[] args) {
		MainAppDay13 mainAppDay13 = new MainAppDay13();
		mainAppDay13.run();
	}

	@Override
	public void run() {
		ApplicationContext context = new ClassPathXmlApplicationContext("beans_day13_annotation.xml");
		System.out.println("-------- day 13: Annotation ------");
